...
parser.add_argument('--dataPath', type=str, default='../', help="directory of input expr matrix")
...
parser.add_argument('--pathToSave', type = str, default = 'data', help = 'directory to save adj matrix')
