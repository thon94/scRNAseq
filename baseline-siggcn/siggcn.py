...
parser.add_argument('--epochs', type=int, default = 200, help='# of epoch to generate misclassification graph')
...
if args.saveResults:
    ...
    # testPreds4save.to_csv(args.outputDir+'/gcn_test_preds_'+ args.dataset+ str(args.num_gene)+ '_after' + str(args.epochs) + '_F' + str(final_net.CL4_F) + '_K' + str(final_net.CL4_K) + '_fc' + str(final_net.FC1_GCN4) + '_fc' + str(final_net.FC2_GCN4) + '.csv')
    # predictions.to_csv(args.outputDir+'/gcn_testProbs_preds_'+ args.dataset+ str(args.num_gene)+ '_after' + str(args.epochs) + '_F' + str(final_net.CL4_F) + '_K' + str(final_net.CL4_K) + '_fc' + str(final_net.FC1_GCN4) + '_fc' + str(final_net.FC2_GCN4) + '.csv')
    # confusionGCN.to_csv(args.outputDir+'/gcn_confuMat_'+ args.dataset+ str(args.num_gene)+ '_after' + str(args.epochs) + '_F' + str(final_net.CL4_F) + '_K' + str(final_net.CL4_K) + '_fc' + str(final_net.FC1_GCN4) + '_fc' + str(final_net.FC2_GCN4) + '.csv')    
    # np.savetxt(args.outputDir+'/newgcn_train_time_'+args.dataset + str(args.num_gene)+ '_after' + str(args.epochs) + '.txt', [t_total_train])   
    # np.savetxt(args.outputDir+'/newgcn_test_time_'+args.dataset + str(args.num_gene)+ '_after' + str(args.epochs) + '.txt', [t_total_test]) 